...
int main( int argc, char* argv[] ) {
  ...
  jk_AntiKt4LC->m_jetDisplayName = "AntiKt";

  JetKinematics* jk_AntiKt4Truth = new JetKinematics();
  jk_AntiKt4Truth->m_jetContainerName = "AntiKt4TruthJets";
  jk_AntiKt4Truth->m_jetDisplayName = "Truth";

  JetKinematics* jk_AntiKt4TruthWZ = new JetKinematics();
  jk_AntiKt4TruthWZ->m_jetContainerName = "AntiKt4TruthWZJets";
  jk_AntiKt4TruthWZ->m_jetDisplayName = "TruthWZ";
